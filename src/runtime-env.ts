...
export function create_runtime_env(
  ...
  return {
    ...
    DEVTREE_TAILSCALE_HOST: tailscale.mode === "direct" ? (tailscale.host ?? undefined) : undefined,
    DEVTREE_TAILSCALE_IPV4: active_tailscale_routing?.tailscale_ipv4 ?? tailscale.ipv4 ?? undefined,
    DEVTREE_TAILSCALE_URL: active_tailscale_routing?.tailscale_url,
    DEVTREE_TAILSCALE_APPLICATION_HOSTNAME: active_tailscale_routing?.tailscale_hostname,
